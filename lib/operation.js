...
function linear (a, b) {
  ...
  } else if (is.number(a) || is.array(a)) {
    this.options.linearA = a;
  } else {
    throw is.invalidParameterError('a', 'numeric or array', a);
  }
  if (!is.defined(b)) {
    this.options.linearB = 0.0;
  } else if (is.number(b) || is.array(b)) {
    this.options.linearB = b;
  } else {
    throw is.invalidParameterError('b', 'numeric or array', b);
  }
  return this;
}
